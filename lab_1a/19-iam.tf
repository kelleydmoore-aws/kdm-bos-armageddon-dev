...
resource "aws_s3_bucket" "alb_logs" {
 bucket        = "bos-alb-logs-321528232261"
 force_destroy = true
}
   ...
   Statement = [
     {
       ...
       Action    = "s3:PutObject"
       Resource  = "arn:aws:s3:::bos-alb-logs-321528232261/alb-logs/AWSLogs/321528232261/*"
     },
     {
       ...
       Resource  = "arn:aws:s3:::bos-alb-logs-321528232261"
     }
   ]
 })
}